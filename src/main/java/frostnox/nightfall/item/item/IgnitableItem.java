...
public class IgnitableItem extends ItemNF {
    ...
    public IgnitableItem(Supplier<? extends Item> ignitedItem, Properties properties) {
        super(properties);
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if(state.is(TagsNF.CAN_IGNITE_ITEMS) || (state.getBlock() instanceof IHeatSource heatSource && heatSource.getHeat(level, pos, state) != TieredHeat.NONE)) {
            ...
            if(fluidSourceResult.getType() == HitResult.Type.MISS) return InteractionResult.PASS;
            else if(fluidSourceResult.getType() != HitResult.Type.BLOCK) return InteractionResult.PASS;
            else {
