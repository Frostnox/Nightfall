...
public enum Metal implements IMetal {
    ...
    COPPER(1, 1, Category.HARD, 10F, 10F, MaterialColor.COLOR_ORANGE, new Color(0xffcb623a), SoundType.COPPER, Map.of(),
            FloatList.of(15, 15, 15, 5, 5, 0), FloatList.of(0.05F, 0.05F, 0.05F, 0F, 0F, -1F)),
    ...
    private final List<Float> defenses, absorptions;
    ...
    Metal(int tier, int workTier, Category category, float strength, float explosionResistance, MaterialColor materialColor, Color color, SoundType sound, Map<IMetal, Vec2f> bases) {
        this(tier, workTier, category, strength, explosionResistance, materialColor, color, sound, bases, FloatList.of(0, 0, 0, 0, 0, 0), FloatList.of(0, 0, 0, 0, 0, 0));
    }

    Metal(int tier, int workTier, Category category, float strength, float explosionResistance, MaterialColor materialColor, Color color, SoundType sound, Map<IMetal, Vec2f> bases, List<Float> defenses, List<Float> absorptions) {
        this.tier = tier;
