...
public class ItemTagsProviderNF extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        copy(TagsNF.PRIMITIVE_ANVILS, TagsNF.PRIMITIVE_ANVILS_ITEM);
        ...
        tag(TagsNF.RECIPE_GROUP).addTags(ItemTags.WOODEN_DOORS, ItemTags.WOODEN_TRAPDOORS, Tags.Items.CHESTS, TagsNF.WOODEN_CHESTS_ITEM, TagsNF.ARMOR_STAND,
                ...
                TagsNF.WOODEN_SHELVES_ITEM, TagsNF.WOODEN_BARRELS_ITEM, ItemTags.WOODEN_FENCES, TagsNF.WOODEN_FENCE_GATES_ITEM, TagsNF.PRIMITIVE_ANVILS_ITEM, TagsNF.METAL_ANVILS_ITEM,
