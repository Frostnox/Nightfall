...
public class BlockEntitiesNF {
    ...
    public static final RegistryObject<BlockEntityType<ItemMoldBlockEntity>> ITEM_MOLD = BLOCK_ENTITIES.register("item_mold", () -> BlockEntityType.Builder.of(ItemMoldBlockEntity::new, Stream.concat(BlocksNF.ARMAMENT_MOLDS.values().stream().map(RegistryObject::get), Stream.of(BlocksNF.INGOT_MOLD.get(), BlocksNF.ARROWHEAD_MOLD.get(), BlocksNF.ROD_MOLD.get())).toArray(Block[]::new)).build(null));
    public static final RegistryObject<BlockEntityType<BlockMoldBlockEntity>> BLOCK_MOLD = BLOCK_ENTITIES.register("block_mold", () -> BlockEntityType.Builder.of(BlockMoldBlockEntity::new, Stream.of(BlocksNF.BLOCK_MOLD.get(), BlocksNF.ANVIL_MOLD.get()).toArray(Block[]::new)).build(null));
    ...
    public static final RegistryObject<BlockEntityType<FireableBlockEntity>> FIREABLE = BLOCK_ENTITIES.register("fireable", () -> BlockEntityType.Builder.of(FireableBlockEntity::new, Stream.concat(BlocksNF.INGOT_PILES.values().stream().map(RegistryObject::get), Stream.of(BlocksNF.RAW_TIN.get(), BlocksNF.RAW_COPPER.get(), BlocksNF.RAW_METEORITE.get(), BlocksNF.RAW_AZURITE.get(), BlocksNF.RAW_HEMATITE.get(), BlocksNF.CLAY_BRICKS.get(), BlocksNF.FIRE_CLAY_BRICKS.get(), BlocksNF.CLAY.get())).toArray(Block[]::new)).build(null));
    public static final RegistryObject<BlockEntityType<FireableHoldableBlockEntity>> FIREABLE_POTTERY = BLOCK_ENTITIES.register("fireable_pottery", () -> BlockEntityType.Builder.of(FireableHoldableBlockEntity::new, Stream.concat(BlocksNF.UNFIRED_ARMAMENT_MOLDS.values().stream().map(RegistryObject::get), Stream.of(BlocksNF.UNFIRED_CRUCIBLE.get(), BlocksNF.UNFIRED_CAULDRON.get(), BlocksNF.UNFIRED_POT.get(), BlocksNF.UNFIRED_INGOT_MOLD.get(), BlocksNF.UNFIRED_ARROWHEAD_MOLD.get(), BlocksNF.UNFIRED_ROD_MOLD.get(), BlocksNF.UNFIRED_BLOCK_MOLD.get(), BlocksNF.UNFIRED_ANVIL_MOLD.get())).toArray(Block[]::new)).build(null));
    ...
    public static final RegistryObject<BlockEntityType<FurnaceChannelBlockEntity>> FURNACE_CHANNEL = BLOCK_ENTITIES.register("furnace_channel", () -> BlockEntityType.Builder.of(FurnaceChannelBlockEntity::new, BlocksNF.MUD_BRICK_CHANNEL.get(), BlocksNF.BRICK_CHANNEL.get(), BlocksNF.FIRE_BRICK_CHANNEL.get()).build(null));
