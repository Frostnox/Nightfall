...
public class ItemsNF {
    ...
    public static final RegistryObject<SpawnEggItem> WOLF_SPAWN_EGG = register(EntitiesNF.WOLF.getId().getPath() + "_spawn_egg",
            () -> new ForgeSpawnEggItem(EntitiesNF.WOLF, 0x413a35, BEAST_COLOR, utility()));
...
//            () -> new ForgeSpawnEggItem(EntitiesNF.OLMUR, 0x95150d, 0x2c2622, utility()));
    ...
    public static final RegistryObject<TongsItem> WOODEN_TONGS = register("wooden_tongs", () -> new TongsItem(1, armament().defaultDurability(TieredItemMaterial.WOOD.getUses())));
    public static final Map<TieredItemMaterial, RegistryObject<TongsItem>> TONGS = DataUtil.mapEnum(TieredItemMaterial.class, mat -> mat.getMetal() == null || mat.getMetal().getCategory() != IMetal.Category.HARD,
            mat -> register(mat.getName() + "_tongs", () -> new TongsItem(mat.getMetal().getTier() + 1, armament().defaultDurability(mat.getUses()))));
    //Equipment
    ...
    public static final RegistryObject<BlockItemNF> MUD_BRICK_CHANNEL = register(BlocksNF.MUD_BRICK_CHANNEL);
    public static final RegistryObject<BlockItemNF> BRICK_CHANNEL = register(BlocksNF.BRICK_CHANNEL);
