...
public class SpawnGroupsNF {
    ...
    public static final RegistryObject<SpawnGroup> COCKATRICE = GROUPS.register("cockatrice", () -> new SurfaceSpawnGroup(
            2, false, EntitiesNF.COCKATRICE.get(), SEA_LEVEL, Integer.MAX_VALUE, 1, 15, 1, 1,
            0.45F, 1F, 0F, 1F, TagsNF.COCKATRICE_SPAWN_BLOCK));
    public static final RegistryObject<SpawnGroup> DEER = GROUPS.register("deer", () -> new SurfaceSpawnGroup(
            7, true, EntitiesNF.DEER.get(), SEA_LEVEL, SEA_LEVEL + 208, 1, 15, 1, 4,
            0.05F, 1F, 0.0F, 1.0F, TagsNF.DEER_SPAWN_BLOCK));
    public static final RegistryObject<SpawnGroup> RABBIT = GROUPS.register("rabbit", () -> new SurfaceSpawnGroup(
            2, true, EntitiesNF.RABBIT.get(), SEA_LEVEL, SEA_LEVEL + 312, 1, 15, 1, 1,
            0.05F, 1F, 0.0F, 1.0F, TagsNF.RABBIT_SPAWN_BLOCK));
    public static final RegistryObject<SpawnGroup> CREEPER = GROUPS.register("creeper", () -> new SurfaceSpawnGroup(
