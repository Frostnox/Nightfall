...
public class SpawnGroupsNF {
    ...
    public static final RegistryObject<SpawnGroup> MERBOR = GROUPS.register("merbor", () -> new MerborSpawnGroup(
            3, true, SEA_LEVEL, SEA_LEVEL + 208, 1, 15,
            0.4F, 1F, 0.4F, 1F, TagsNF.NATURAL_SOIL));
