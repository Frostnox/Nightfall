...
/**
 * Slightly modified version of K.jpg's OpenSimplex 2, faster variant
 * From https://github.com/KdotJPG/OpenSimplex2/blob/master/java/OpenSimplex2.java
 */
public class SimplexNoiseFast {
    ...
    public SimplexNoiseFast(long seed) {
        this.seed = seed;
    }
