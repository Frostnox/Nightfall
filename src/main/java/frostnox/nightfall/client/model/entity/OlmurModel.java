...
public class OlmurModel extends AnimatedModel<OlmurEntity> implements HeadedModel {
    ...
    public OlmurModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(OlmurEntity entity, float limbSwing, float limbSwingAmount, float time, float netHeadYaw, float headPitch) {
        resetPose();
        float speed = 3.3F;
    ...
    @Override
    public void animateStun(int frame, int duration, int dir, float mag, OlmurEntity user, AnimationCalculator mCalc, Vector3f mVec, float partialTicks) {
