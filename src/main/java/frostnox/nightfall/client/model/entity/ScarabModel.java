...
public class ScarabModel extends AnimatedModel<ScarabEntity> implements HeadedModel {
    ...
    @Override
    public void setupAnim(ScarabEntity entity, float limbSwing, float limbSwingAmount, float time, float netHeadYaw, float headPitch) {
        resetPose();
        float speed = 3.3F;
    ...
    @Override
    public void animateStun(int frame, int duration, int dir, float mag, ScarabEntity user, AnimationCalculator mCalc, Vector3f mVec, float partialTicks) {
