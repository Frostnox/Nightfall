...
public class SkullwormModel extends AnimatedModel<SkullwormEntity> implements HeadedModel {
    ...
    public SkullwormModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(SkullwormEntity entity, float limbSwing, float limbSwingAmount, float time, float netHeadYaw, float headPitch) {
        resetPose();
        float speed = 3.3F;
    ...
    @Override
    public void animateStun(int frame, int duration, int dir, float mag, SkullwormEntity user, AnimationCalculator mCalc, Vector3f mVec, float partialTicks) {
