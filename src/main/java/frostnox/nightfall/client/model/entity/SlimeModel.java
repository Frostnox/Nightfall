...
public class SlimeModel extends AnimatedModel<SlimeEntity> {
    ...
    @Override
    public void setupAnim(SlimeEntity entity, float limbSwing, float limbSwingAmount, float time, float netHeadYaw, float headPitch) {
        resetPose();
        float speed = 3.3F;
    ...
    @Override
    public void animateStun(int frame, int duration, int dir, float mag, SlimeEntity user, AnimationCalculator mCalc, Vector3f mVec, float partialTicks) {
