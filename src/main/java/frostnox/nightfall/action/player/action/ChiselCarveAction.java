...
public class ChiselCarveAction extends CarveAction {
    public ChiselCarveAction(int[] duration, Properties properties) {
        super(properties, duration);
    }

    public ChiselCarveAction(Properties properties, int... duration) {
        super(properties, duration);
    }
