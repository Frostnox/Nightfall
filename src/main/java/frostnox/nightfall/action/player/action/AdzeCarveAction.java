...
public class AdzeCarveAction extends WoodCarveAction {
    public AdzeCarveAction(int[] duration, Properties properties) {
        super(properties, duration);
    }

    public AdzeCarveAction(Properties properties, int... duration) {
        super(properties, duration);
    }
    ...
    public void transformModelFP(int state, int frame, int duration, float charge, LivingEntity user, AnimationData data) {
        ...
        switch(state) {
            case 0 -> {
                tCalc.add(-13F/16F, 1F/16F, 2F/16F);
                rCalc.extend(20, 145, -20);
            }
            case 1 -> {
