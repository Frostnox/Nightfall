...
public class Dig extends PlayerAction {
    public Dig(int[] duration, Properties properties) {
        super(properties, duration);
    }

    public Dig(Properties properties, int... duration) {
        super(properties, duration);
    }
        ...
        if(data.size() == 6) {
            ...
            switch (state) {
                case 0 -> {
                    ...
                    rightHand.rCalc.extend(30 + pitch / 2F, 0, 10);
                    leftArm.rCalc.extend(-Math.abs(pitch/2F), 0, 0);
